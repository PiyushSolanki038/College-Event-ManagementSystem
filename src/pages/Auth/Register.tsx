    ...
    <div className="space-y-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-start gap-3 py-3 px-1">
          <input 
            ...
            id="terms" 
            required 
            className="mt-1 w-4 h-4 rounded-lg border-slate-200 text-orange-500 focus:ring-orange-500/20 cursor-pointer accent-orange-500"
          />
      ...
      <div className="pt-4">
        <div className="text-center relative mb-8">
          ...
          <span className="relative bg-white px-5 text-[10px] font-black text-slate-300 uppercase tracking-widest leading-none">Global Foundation</span>
        </div>
